...
{% assign total_threats = site.data.threats.size %}
{% assign covered_threats = site.data.threats | where_exp: "t", "t.mitigations.size > 0" | size %}
